...
from common import depth_wise_conv
def get_symbol_train(num_classes=20):
    ...
    #conv1_1 = depth_wise_conv(data, 3, 64, kernel = (3,3), pad = (1,1), name = 'conv1_1')
    relu1_1 = mx.symbol.Activation(data=conv1_1, act_type="relu", name="relu1_1")
    
    conv1_2 = mx.symbol.Convolution(
        data=relu1_1, kernel=(3, 3), pad=(1, 1), num_filter=64, name="conv1_2")
    #conv1_2 = depth_wise_conv(relu1_1, 64, 64, kernel = (3,3), pad = (1,1), name = 'conv1_2')
    ...
    # group 5
    conv5_1 = depth_wise_conv(pool4, 512, 512, kernel = (3,3), pad = (1,1), name = 'conv5_1')
    relu5_1 = mx.symbol.Activation(data=conv5_1, act_type="relu", name="relu5_1")
    conv5_2 = depth_wise_conv(relu5_1, 512, 512, kernel = (3,3), pad = (1,1), name = 'conv5_2')
    relu5_2 = mx.symbol.Activation(data=conv5_2, act_type="relu", name="relu5_2")
    conv5_3 = depth_wise_conv(relu5_2, 512, 512, kernel = (3,3), pad = (1,1), name = 'conv5_3')
